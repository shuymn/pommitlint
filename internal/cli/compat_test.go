...
func TestCompatDefaultIgnores(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:        "merge-branch-with-multiple-newlines",
			origin:      "@commitlint/is-ignored/src/is-ignored.test.ts",
		...
		{
			name:        "merge-tag-arbitrary-name",
			origin:      "@commitlint/is-ignored/src/is-ignored.test.ts",
			message:     "Merge tag 'a tag'",
			wantIgnored: true,
			wantExit:    0,
		},
		{
			name:        "merge-tag-with-multiple-newlines",
			origin:      "@commitlint/is-ignored/src/is-ignored.test.ts",
			message:     "Merge tag '1.1.1'\r\n\r\n\r\n",
			wantIgnored: true,
			wantExit:    0,
		...
		{
			name:        "merge-tag-with-comment-after-newline",
			origin:      "@commitlint/is-ignored/src/is-ignored.test.ts",
			message:     "Merge tag '1.1.1'\r\n # some comment",
			wantIgnored: true,
			wantExit:    0,
		...
		{
			name:        "semver-arbitrary-tag",
			origin:      "@commitlint/is-ignored/src/is-ignored.test.ts",
			message:     "0.0.1-some-crazy-tag",
			wantIgnored: true,
			wantExit:    0,
		},
		{
			name:        "semver-with-chore",
			origin:      "@commitlint/is-ignored/src/is-ignored.test.ts",
			message:     "chore: 0.0.1",
			wantIgnored: true,
			wantExit:    0,
		...
		{
			name:        "semver-with-multiple-amendments",
			origin:      "@commitlint/is-ignored/src/is-ignored.test.ts",
		...
		{
			name:        "bitbucket-merge-into-branch",
			origin:      "@commitlint/is-ignored/src/is-ignored.test.ts",
			message:     "Merged develop into feature/component-form-select-card",
			wantIgnored: true,
			wantExit:    0,
		},
		{
